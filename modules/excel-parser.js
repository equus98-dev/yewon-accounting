          ...
          <div class="modal-body">
            ...
            <div class="form-grid" id="config-form">
              <div class="form-group">
                <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">은행명 <span class="required">*</span></label>
                <input type="text" id="cfg-bank-name" class="form-control" placeholder="예: 국민은행, 우리은행">
              </div>
              <div class="form-group">
                <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">헤더 행 번호 (1부터 시작)</label>
                <input type="number" id="cfg-header-row" class="form-control" value="1" min="1">
              </div>
              <div class="form-group">
                <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">날짜 컬럼 (예: A, B, 0, 1)</label>
                <input type="text" id="cfg-col-date" class="form-control" placeholder="A">
              </div>
              <div class="form-group">
                <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">적요 컬럼</label>
                <input type="text" id="cfg-col-desc" class="form-control" placeholder="B">
              </div>
              <div class="form-group">
                <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">입금 컬럼</label>
                <input type="text" id="cfg-col-income" class="form-control" placeholder="C">
              </div>
              <div class="form-group">
                <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">출금 컬럼</label>
                <input type="text" id="cfg-col-expense" class="form-control" placeholder="D">
              </div>
              <div class="form-group">
                <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">잔액 컬럼 (선택)</label>
                <input type="text" id="cfg-col-balance" class="form-control" placeholder="E">
              </div>
              <div class="form-group">
                <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">계좌번호 컬럼 (선택)</label>
  ...
  function renderExcelUploadUI() {
    ...
    return `
      <div class="card">
        ...
        <div class="form-row">
          <div class="form-group">
            <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">은행 설정</label>
          ...
          <div class="form-group">
            <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">대상 과제 (미선택 시 계좌번호로 자동 배정)</label>
  ...
  function renderApiSyncUI() {
    ...
    return `
      <div class="card">
        ...
        <div class="form-grid">
          <div class="form-group">
            <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">은행 선택 <span class="required">*</span></label>
          ...
          <div class="form-group">
            <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">계좌번호 <span class="required">*</span></label>
            <input type="text" id="api-account-no" class="form-control" placeholder="숫자만 입력">
          </div>
          <div class="form-group">
            <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">계좌 비밀번호 (4자리) <span class="required">*</span></label>
            <input type="password" id="api-account-pw" class="form-control" maxlength="4" placeholder="****">
          </div>
          <div class="form-group">
            <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">주민(사업자)번호 앞 6자리 <span class="required">*</span></label>
            <input type="text" id="api-resident-no" class="form-control" maxlength="6" placeholder="예: 800101">
          </div>
          <div class="form-group">
            <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">조회 시작일</label>
            <input type="date" id="api-start-date" class="form-control" value="${startDate}">
          </div>
          <div class="form-group">
            <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">조회 종료일</label>
            <input type="date" id="api-end-date" class="form-control" value="${today}">
          </div>
          <div class="form-group">
            <label style="display: block; background: #64748b; color: #fff; padding: 2px 10px; border-radius: 4px; margin-bottom: 8px; font-weight: 600; font-size: 13px;">대상 과제 배정</label>
